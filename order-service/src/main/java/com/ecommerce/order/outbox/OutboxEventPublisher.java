...
public class OutboxEventPublisher {
     ...
     * @param eventType The type of event (e.g., "OrderCreated", "PaymentProcessed")
    ...
    /**
     * Check if an event has already been published for this aggregate and event type.
     * Useful for idempotency checks.
     */
    public boolean isEventAlreadyPublished(String aggregateType, String aggregateId, String eventType) {
        return outboxRepository
            .findByAggregateTypeAndAggregateIdAndEventType(aggregateType, aggregateId, eventType)
